...
from dellus.database.dbutil import dbconnection, utcnow
from dellus.exception.error import ShortURLUnavailable
...
class Link(Model):
    ...
    def generate_short_code(_, connection, target):
        ...
        from dellus.core.link_helper import next_short_code
